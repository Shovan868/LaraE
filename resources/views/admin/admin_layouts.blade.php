...
<html lang="en">
  <head>
    ...
    <title>Ecommerce Admin Web Panel</title>
  ...
  <body>
     ...
     @else
        <!-- ########## START: LEFT PANEL ########## -->
  <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> SellOut</a></div>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('public/backend/img/face99.jpg') }}" class="wd-50 rounded-rectangle" alt="">
            </a>
